...
const CartItem = ({ onContinueShopping }) => {
  ...
  const handleContinueShopping = () => {
    if (onContinueShopping) {
      onContinueShopping(); // Calls the function passed from the parent to navigate back to the shopping page
    }
  };
  ...
  const handleDecrement = (item) => {
    if (item.quantity > 1) {
      ...
      handleRemove(item); // Remove the item if the quantity reaches 0
    }
  };
